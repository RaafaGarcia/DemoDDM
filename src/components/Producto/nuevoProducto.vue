                ...
                <div class="container-fluid">
                    ...
                    <div class="container">
                        ...
                        <div  class="p-2 mb-3" style="background:white;border-radius:5px;border: 1px solid black">
                            <div class="">
                                <label for="" class="h1">Nuevo Producto</label>
       ...
       actions(action,id){
        ...
        nuevo(){
           ...
           let idNew = 0
            ...
            axios.get("http://mueblesdimmsa.com/ddm/productos.php?accion=top")

            .then(function(response){
                
                idNew=parseInt(response.data.data[0].ID_PRODUCTO)+1
            ...
            .catch(response => {
               ...
               $el.getModal(3,"Error al obtener el id")
        ...
        guardar(){
            ...
            if (this.validarOrden()==false) {
                    ...
                    let formdata=new FormData()
                        ...
                        axios.post("http://mueblesdimmsa.com/ddm/productos.php?accion=insertar",formdata)
                        ...
                        .then(function(response){
                            ...
                            if (response.data.error == true){
                                ...
                                $el.getModal(1,"El producto se ha guardado con éxito")
                ...
                $el.getModal(2,"Llene los campos obligatorios")
            }     
        },
