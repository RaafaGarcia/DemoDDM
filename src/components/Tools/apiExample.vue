            ...
            <table>
                ...
                <tbody>
                    <tr v-for="paisaje in paisajes" :key="paisaje.asas">
                        ...
                        <td><img :src="'http://mueblesdimmsa.com:8080/MyWallet/img/'+paisaje.foto" width="100" alt=""></td>
                        <td>
...
export default {
  ...
  methods:{
    mostrarPaisajes:function(){
      let el=this
        axios.get("http://mueblesdimmsa.com:8080/MyWallet/api.php?accion=mostrar")
